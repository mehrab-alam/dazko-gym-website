            ...
            {carouselDetail.map((profile, i) => {
              return (
                <div className={styles.carouselProWraper} key={i}>
                  <div className={styles.headerComa}>
                    {shown && <Image src='/img/dazko-img/213175_f10d_icon.png' alt='' height={60} width={60} />}
                  </div>
                  <div key={i} className={`${styles.profileConatiner} `}>
                    <p>{profile.para}</p>
                    <div>
                      {shown && <Image src={profile.img} alt='' height={80} width={80} />}
                      <div>
                        <h3>ROGER SCOTT</h3>
